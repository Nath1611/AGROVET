...
namespace AGROVET.Commons
{
    public static class ObjetosGlobales
    {
       ...
       + @"([a-zA-Z0-9]+[\w-]+\.)+[a-zA-Z]{1}[a-zA-Z0-9-]{1,23})$";
        ...
        public static Formularios.FrmGestionUsuarios FormularioGestionUsuarios = new Formularios.FrmGestionUsuarios();

        public static Formularios.FrmGestionProveedores FormularioGestionProveedores = new Formularios.FrmGestionProveedores();

        public static Formularios.FrmGestionProducto FormularioGestionProductos = new Formularios.FrmGestionProducto();

        public static Formularios.FrmGestionTipoProducto FormularioGestionTipoProductos = new Formularios.FrmGestionTipoProducto();
